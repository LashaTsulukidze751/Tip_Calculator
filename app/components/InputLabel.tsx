...
import { billState, peopleAmountState } from "../state";
  ...
  return (
    <div className=" flex flex-col mb-8">
      <div className="flex justify-between">
        {icon=='dollar'? <p>Bill</p>:<p>Number of People</p>}
        {error?<p>Cennot Be Zero</p>:<p></p>}
      </div>
      <div className=" flex w-full justify-around h-12 rounded bg-VeryLightCrayishCyan">
        ...
        <input
          value={icon == "dollar" ? bill : peopleAmount}
          type="number"
          className="w-10/12 bg-VeryLightCrayishCyan text-right text-2xl text-sky-900 outline-none"
